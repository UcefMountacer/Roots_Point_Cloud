...
def parse_args():
    ...
    parser.add_argument('--op', type=str, help="Opertaion to execute: 'OF' for optical flow, 'C' for auto calibration", required=1)
...
if __name__ == "__main__":
    ...
    if operation == 'OF':
        ...
        generate_video(list_of_outputs, output_flow_dir)
