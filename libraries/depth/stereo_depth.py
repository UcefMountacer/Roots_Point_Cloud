...
def init_stereo_method(minDisparity = 0 , numDisparities = 16*35, blockSize = 1, lmbda = 10000, sigma = 3):
...
if __name__ == '__main__':
    ...
    # list1 = list(map(remove_blur, list1))
    # list2 = list(map(remove_blur, list2))
